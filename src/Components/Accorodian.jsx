const Accorodian = () => {
    return (
        <div className="mt-10 space-y-4 bg-blue-200 p-3 lg:p-10 rounded-lg  shadow-xl  text-center ">
            <h2 className=" mb-10 text-xl lg:text-3xl font-medium">Frequently asked questions</h2>
            <div className="collapse bg-base-200">
                <input type="radio" name="my-accordion-1" defaultChecked />
                <div className="collapse-title lg:text-2xl font-medium">
                    Q: What type of activities do you offer at your resort?
                </div>
                <div className=" lg:text-xl collapse-content">
